    ...
    <div className="min-h-screen flex flex-col justify-center items-center">
      ...
      <div className="flex flex-col lg:py-6 py-4 justify-center">
        <div className="flex flex-col gap-4 lg:gap-8 justify-center">
          ...
          <button
            className="flex justify-center hover:scale-110 border-[1px] w-[100px] lg:w-auto border-white text-white hover:bg-white hover:text-black rounded-lg px-4 lg:px-[10px] lg:py-[20px]"
            style={{
              // fontSize: "1.5rem",
              // padding: "10px 20px",
              // borderRadius: "10px",
