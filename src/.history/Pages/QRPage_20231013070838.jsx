    ...
    <div className="min-h-screen flex flex-col justify-center items-center">
      ...
      <div className="flex flex-col lg:py-6 py-4">
        <div className="flex flex-col gap-4 lg:gap-8">
          ...
          <button
            className="border-[1px] xs:w-[100px] w-auto flex justify-center border-white text-white hover:bg-white hover:text-black rounded-lg px-4 lg:px-[10px] lg:py-[20px]"
            style={{
              // fontSize: "1.5rem",
              // padding: "10px 20px",
              // borderRadius: "10px",
